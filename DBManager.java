  ...
  public static void createTables() {
    ...
    try (Statement s = conn.createStatement()) {
        ...
        s.execute("CREATE TABLE IF NOT EXISTS Users ("
                ...
                + ") ENGINE=InnoDB;"); //the engine innodb thing was something i tried when debugging. yes i dont understand it but i hope its ok since its not vital to the algorithm. i had trouble with my connections :(.
