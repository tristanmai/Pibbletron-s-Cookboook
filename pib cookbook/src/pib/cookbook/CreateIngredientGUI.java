...
public class CreateIngredientGUI extends JFrame implements ActionListener
{
  ...
  public CreateIngredientGUI(int userID)
  {
    ...
    JButton ingredientsButton = new JButton("Create");
  ...
  {
    new CreateIngredientGUI(5).setVisible(true);
  }
}
